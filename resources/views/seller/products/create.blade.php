    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border border-vintage-200 shadow-xl sm:rounded-lg p-6">
                <h2 class="text-2xl font-bold mb-6 font-serif text-vintage-900">List New Artifact</h2>
                ...
                <form action="{{ route('seller.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex justify-end mt-6">
                        <a href="{{ route('seller.products.index') }}" class="text-gray-600 px-4 py-2 mr-2 font-serif hover:text-gray-900">Cancel</a>
                        <button type="submit" class="btn-vintage">List Artifact</button>
                    </div>
                </form>
            </div>
        </div>
