    ...
    public function run(): void
    {
        ...
        $bookList = [
            [
                ...
                'price' => 45.00,
                'image' => 'Images/Products/Books/1.The Illuminator’s Handbook.jpg'
            ],
            [
                ...
                'price' => 30.00,
                'image' => 'Images/Products/Books/2.The Order of Melchizedek.jpg'
            ],
            [
                ...
                'price' => 25.00,
                'image' => 'Images/Products/Books/3. The Book of Enoch with Ancient Secrets of Enoch.jpg'
            ],
            [
                ...
                'price' => 35.00,
                'image' => 'Images/Products/Books/4. Adam and Eve and the Great Reset.jpg'
            ],
            [
                'name' => 'The Zoist',
                'description' => 'Volume 2. A Journal Of Cerebral Physiology & Mesmerism (1843-1856).',
                'price' => 40.00,
                'image' => 'Images/Products/Books/5. The Zoist.jpg'
            ],
            [
                ...
                'price' => 50.00,
                'image' => 'Images/Products/Books/6. The Black Library.jpg'
            ],
        ];
        ...
        $furnList = [
            [
                ...
                'price' => 180.00,
                'image' => 'Images/Products/Furniture/1. Victorian Whatnot Shelves.jpg'
            ],
            [
                ...
                'price' => 350.00,
                'image' => 'Images/Products/Furniture/2. Saddle Stitch Leather Desk Chair.jpg'
            ],
            [
                'name' => 'Victorian Walnut Armoire',
                'description' => 'Exquisite Victorian era walnut wardrobe (circa 1837-1910), meticulously restored.',
                'price' => 1200.00,
                'image' => 'Images/Products/Furniture/3. Early 19th Century Antique Victorian Walnut Armoire, Wardrobe.jpg'
            ],
            [
                ...
                'price' => 220.00,
                'image' => 'Images/Products/Furniture/4. Vintage Georgian Style Mahogany Storage Box.jpg'
            ],
            [
                ...
                'price' => 600.00,
                'image' => 'Images/Products/Furniture/5. Vintage Vanity Beauty.jpg'
            ],
            [
                ...
                'price' => 1500.00,
                'image' => 'Images/Products/Furniture/6. Vintage Louis XVI Ormolu Mounted Credenza.jpg'
            ],
        ];
        ...
        $ornList = [
            [
                ...
                'price' => 55.00,
                'image' => 'Images/Products/Ornaments/1. Unique Set of 10 Bronze and Gold Glass Christmas Ornaments.jpg'
            ],
            [
                'name' => 'Sterling Silver Flower Brooch',
                'description' => 'Antique Sterling Silver Flower And Cupid Monogrammed Brooch.',
                'price' => 85.00,
                'image' => 'Images/Products/Ornaments/2. Antique Sterling silver flower and cupid monogrammed brooch.jpg'
            ],
            [
                'name' => 'Wrought Iron Gas Lamp',
                'description' => 'Indoor nostalgic wall lamp, double wall sconce.',
                'price' => 75.00,
                'image' => 'Images/Products/Ornaments/3. Wrought Iron Gas Lamp Double Wall Sconce.jpg'
            ],
            [
        ...
        $artList = [
            [
                ...
                'price' => 200.00,
                'image' => 'Images/Products/Paintings/1. Victorian Ballroom Art,.jpg' // Note the comma
            ],
            [
                'name' => 'Vintage Botanical Wildflowers',
                'description' => 'Victorian Vintage Botanical Wildflowers Digital Art in oil painting style].',
                'price' => 90.00,
                'image' => 'Images/Products/Paintings/2. Victorian Vintage Botanical Wildflowers Art Digital Products.png' // .png
            ],
            [
                ...
                'price' => 350.00,
                'image' => 'Images/Products/Paintings/3. Oil Painting Incredible Antique Hand-Painted Oil Painting.png' // .png
            ],
            [
                ...
                'price' => 60.00,
                'image' => 'Images/Products/Paintings/4. Avezano Wild Flowers Oil Painting Style Photography Backdrop.jpg'
            ],
            [
                'name' => 'Floral Woman Decoupage Paper',
                'description' => 'Sticky Rice Decoupage Paper featuring a floral woman design. A3 size.',
                'price' => 20.00,
                'image' => 'Images/Products/Paintings/5. Floral Woman Sticky Rice Paper for Decoupage - A3.jpg'
            ],
            [
                'name' => 'Trees Oil Painting Backdrop',
                'description' => 'Avezano Trees Oil Painting Style Photography Backdrop. Durable and portable.',
                'price' => 65.00,
                'image' => 'Images/Products/Paintings/6. Avezano Trees Oil Painting Style Photography Backdrop.jpg'
            ],
        ];
